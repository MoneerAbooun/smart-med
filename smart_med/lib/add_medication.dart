...
class _AddMedicationPageState extends State<AddMedicationPage> {
  ...
  Future<void> addMedication() async {
    ...
    DocumentReference<Map<String, dynamic>>? medicationRef;

    try {
      medicationRef = await FirebaseFirestore.instance
          .collection('Users')
          .doc(user.uid)
      ...
      await medicationRef.update({'notificationIds': notificationIds});
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: customInputDecoration('Times per day (1-6) *'),
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
