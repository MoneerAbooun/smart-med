...
class MedicationRecord {
  ...
  String get dosage {
    ...
    return normalizedUnit.isEmpty ? formattedDose : '$formattedDose $normalizedUnit';
  }
  ...
  factory MedicationRecord.fromMap(String id, Map<String, dynamic> map) {
    ...
    return MedicationRecord(
      ...
      status:
          FirestoreValueParser.stringOrNull(map['status']) ?? 'active',
  ...
  static List<MedicationScheduleTime> _parseScheduledTimes(
    ...
    if (scheduledTimesValue is Iterable) {
      return scheduledTimesValue
          .map((item) => MedicationScheduleTime.fromMap(
                FirestoreValueParser.map(item),
              ))
          .toList(growable: false);
    }
  ...
  static int _parseFrequencyPerDay(Map<String, dynamic> map, int reminderCount) {
