...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget buildAiSafetyReadinessCard(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
    final textTheme = Theme.of(context).textTheme;
        ...
        children: [
          ...
          Text(
            missingFields.isEmpty
                ...
                : 'Missing profile details may reduce warning accuracy. Smart Med uses this profile only to personalize medication cautions and safer-use advice.',
            style: textTheme.bodyMedium?.copyWith(
              color: colorScheme.onSurfaceVariant,
            ),
          ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                buildAiSafetyReadinessCard(context),
                                const SizedBox(height: 25),
